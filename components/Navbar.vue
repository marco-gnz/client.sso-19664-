      ...
      <b-navbar toggleable="lg" type="light" variant="faded" class="is-transparent is-fixed-top">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav v-if="$auth.loggedIn">
            ...
            <b-nav-item href="#" to="/redes" v-if="$auth.user.permissions_roles.includes('ver-dato-maestro') || $auth.user.permissions.includes('ver-dato-maestro')">Mantenedores</b-nav-item>
