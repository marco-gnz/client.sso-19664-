      ...
      <template v-if="devolucion != '' || devolucion != null">
        <div class="row">
            <div class="col-md-6">
                ...
                <p v-if="devolucion.diferencia"><strong>En días</strong>: {{ `${devolucion.diferencia.years > 1 ? `${devolucion.diferencia.years} años` : `${devolucion.diferencia.years} año`}, ${devolucion.diferencia.months > 1 ? `${devolucion.diferencia.months} meses` : `${devolucion.diferencia.months} mes`} y ${Math.round(devolucion.diferencia.days) > 1 ? `${Math.round(devolucion.diferencia.days)} días` : `${Math.round(devolucion.diferencia.days)} día`}` }}</p>
