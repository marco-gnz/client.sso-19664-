<template>
  <div>
    ...
    <li class="list-group-item media"><strong>Devoluciones realizadas</strong>: <span class="text-success">{{ `${totalDevolucion.years} ${totalDevolucion.years > 1 ? `años` : `año`}, ${totalDevolucion.months} ${totalDevolucion.months > 1 ? `meses` : `mes`} y ${totalDevolucion.days} ${totalDevolucion.days > 1 ? `días` : `día`}` }}</span></li>
    <li class="list-group-item media"><strong>Interrupciones realizadas</strong>: <span class="text-danger">{{ `${totalInterrupcion.years} ${totalInterrupcion.years > 1 ? `años` : `año`}, ${totalInterrupcion.months} ${totalInterrupcion.months > 1 ? `meses` : `mes`} y ${totalInterrupcion.days} ${totalInterrupcion.days > 1 ? `días` : `día`}` }}</span></li>
