      ...
      <template v-if="devolucion != '' || devolucion != null">
        <div class="row">
            <div class="col-md-6">
                ...
                <p v-if="devolucion.diferencia"><strong>Diferencia periodo</strong>: {{ `${devolucion.diferencia.years > 1 ? `${devolucion.diferencia.years} años` : `${devolucion.diferencia.years} año`}, ${devolucion.diferencia.months > 1 ? `${devolucion.diferencia.months} meses` : `${devolucion.diferencia.months} mes`} y ${devolucion.diferencia.days > 1 ? `${devolucion.diferencia.days} días` : `${devolucion.diferencia.days} día`}` }}</p>
                <p v-if="devolucion.tipo_contrato"><strong>Tipo de contrato</strong>: {{devolucion.tipo_contrato.nombre}} hrs.</p>
                <p v-if="devolucion.diferencia_calculate"><strong>Diferencia con horas</strong>: {{ `${devolucion.diferencia_calculate.years > 1 ? `${devolucion.diferencia_calculate.years} años` : `${devolucion.diferencia_calculate.years} año`}, ${devolucion.diferencia_calculate.months > 1 ? `${devolucion.diferencia_calculate.months} meses` : `${devolucion.diferencia_calculate.months} mes`} y ${devolucion.diferencia_calculate.days > 1 ? `${Math.round(devolucion.diferencia_calculate.days)} días` : `${Math.round(devolucion.diferencia_calculate.days)} día`}` }}</p>
